<x-guest-layout>
    <div class="flex justify-end p-5">
        <img src="assets/dark_mode_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg" height="38" width="38" id="lightmode">
    </div>
    <main class="flex justify-center content-center">
        <div class="w-80 rounded-xl absolute top-1/4">
            ...
            <form action="{{ route('login') }}" method="POST" class="flex flex-col relative top-1/4">
                ...
                <input type="password" id="" class="text-white p-3 m-7 bg-slate-900 rounded-xl" placeholder="password"
                ...
                <div class="flex justify-center">
                    <div class="flex items-center justify-end mt-4">
                        ...
                        @endif
                        <input type="image" src="assets/login_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg" height="64"
                            width="64">
                    </div>
                </div>
            </form>
